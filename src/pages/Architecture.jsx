...
const mainBg = '#0a0a0a'; // site-wide black
const cardBg = '#fff';
...
const Architecture = () => {
  ...
  return (
    <div className="animate-fadein min-h-screen" style={{ background: '#000', color: textColor }}>
      {/* Inject custom style for pulse animation */}
      <style>{pulseStyle}</style>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className={`text-4xl font-bold mb-8 ${headingRed}`}>Architecture</h1>
        {/* Mathematical Foundations Section */}
        <div className="rounded-xl px-8 py-12 shadow-lg border-[1pt] border-gray-200 mb-8" style={{ background: cardBg }}>
          <div className="w-full rounded-xl p-8" style={{ background: cardBg, color: textColor }}>
            <h2 className={`text-3xl font-bold mb-4 ${headingRed}`}>Mathematical Foundations</h2>
            <div className="flex justify-center mb-8">
              <BlockMath math={String.raw`\text{Spectral Analysis} \rightarrow \text{Resonance Fields} \rightarrow \text{Cognitive Mapping}`}/>
            </div>
            <div className="p-8 min-h-screen rounded-xl" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>What is SRC⁹?</h2>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.1 Definition and Rationale</h3>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.2 Motivation: Why SRC⁹?</h3>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.3 System Overview: A Perception-to-Structure Pipeline</h3>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.4 Formal Notation</h3>
              <p>
              ...
              <div className="my-4">
                ...
                <b>From C³:</b>
                <div className="flex justify-center">
                  <BlockMath math={String.raw`C^3(t) = \sum_i w_i \cdot \mathrm{Unit}_i(t), \quad \mathrm{Unit}_i(t) = \sum_j w_{ij} \cdot \mathrm{Node}_j(t)`} />
                </div>
              </div>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.5 Tools Used in S³</h3>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.6 Scientific Rationale</h3>
              <p>
            ...
            {/* R³ Section */}
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>What is S³? — Spectral Sound Space</h2>

              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.1 Function</h3>
              <p>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.2 Core Processes</h3>
              <ul className="list-disc ml-8 my-2">
                <li>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.3 Spectral Field Representation</h3>
              <p>
              ...
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`\mathrm{RFM}(f, t) = \sum_i A_i(t) \cdot \exp\left(-\frac{(f - f_i(t))^2}{2\sigma^2}\right)`} />
              </div>
              <p>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.4 Scientific Basis</h3>
              <p>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>1.5 Cross-Style and Cross-Tuning Generalizability</h3>
              <p>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>What is R³?</h2>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.1 Function</h3>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.2 Core Units</h3>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.3 Field Representation</h3>
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`\mathrm{RFM}(f, t) = \sum_i A_i(t) \cdot \exp\left(-\frac{(f - f_i(t))^2}{2\sigma^2}\right)`} />
              </div>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.4 Resonance Vector</h3>
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`\vec{\text{CRV}} = [\text{TPS}, \text{TFI}, \text{NSF}] \in [0,1]^3`} />
              </div>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.5 Scientific Basis</h3>
              <p>
                R³ builds upon:
              </p>
              <ul className="list-disc ml-8 my-2">
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>3.1 PR Estimation (Phantom Root)</h3>
              <p>
              ...
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`r^* = \arg\min_r \left( \frac{1}{n} \sum_i \left| \frac{f_i - r \cdot h_i}{r \cdot h_i} \right| \right)`} />
              </div>
              <p>
                Where <i>hᵢ</i> are harmonic template integers (e.g., [1, 2, 3, 4]).
              </p>

              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>3.2 Just Intonation Vector Representation</h3>
              <p>
                Each frequency can be projected into a prime-exponent vector space:
              </p>
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`\vec{v}_i = (x_2, x_3, x_5, x_7, \dots) \quad \text{where } f_i = 2^{x_2} \cdot 3^{x_3} \cdot 5^{x_5} \cdots`} />
              </div>
              <p>The mean vector then becomes:</p>
              <div className="flex justify-center my-4">
                <BlockMath math={String.raw`\vec{v}_{PR} = \frac{1}{N} \sum_i \vec{v}_i`} />
              </div>
              <p>
                This average vector is mapped back to the frequency domain to compute the phantom root in symbolic–harmonic space.
              </p>

              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>3.3 Summary Table of Key Equations</h3>
                ...
                <table className="table-auto border border-gray-200 w-full">
                  ...
                  <tbody className="text-black">
                    <tr>
                      ...
                      <td className="border px-4 py-2"><BlockMath math={String.raw`\Phi(t) = \sum_{i<j} \frac{A_i A_j}{|f_i - f_j| + \epsilon}`} /></td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">RFM (Field)</td>
                      <td className="border px-4 py-2"><BlockMath math={String.raw`\mathrm{RFM}(f, t) = \sum_i A_i(t) \cdot \exp\left(-\frac{(f - f_i(t))^2}{2\sigma^2}\right)`} /></td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">Gradient</td>
                      <td className="border px-4 py-2"><BlockMath math={String.raw`\nabla \mathrm{RFM} = \partial \mathrm{RFM} / \partial f`} /></td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">CRV</td>
                      <td className="border px-4 py-2"><BlockMath math={String.raw`[\text{TPS}, \text{TFI}, \text{NSF}]`} /></td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">PR Estimation</td>
                      <td className="border px-4 py-2"><BlockMath math={String.raw`r = \arg\min_r \sum_i |f_i - r h_i| / r h_i`} /></td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">NSF</td>
                      <td className="border px-4 py-2"><BlockMath math={String.raw`\sum_t \Phi(t) e^{-\alpha t}`} /></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>4. Temporal Architecture and Synchronicity</h2>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>4.1 Features</h3>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>4.2 Cognitive Color Mapping</h3>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>4.3 RFM Surface Rendering in Unity</h3>
              <p>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>4.4 Animation and Playback Features</h3>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>4.5 Use Cases</h3>
              <ul className="list-disc ml-8 my-2">
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>5. Data Format & Canonical JSON Frame</h2>
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>5.1 Frame JSON Example</h3>

              <pre className="bg-gray-200 text-black text-sm rounded p-4 overflow-x-auto">
{`{
  "time": 3.2,
  "partials": [
  ...
  "crv": { "TPS": 0.812, "TFI": 0.694, "NSF": 0.039 }
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>5.2 Field Specifications</h3>
              <ul className="list-disc ml-8 my-2">
            ...
            <div className="p-8" style={{ background: cardBg, color: textColor }}>
              <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>8. System Contributions & Theoretical Shift</h2>

              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>8.1 Motivation for Integration</h3>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>8.2 Novel Contributions by Module</h3>
              <h4 className={`text-indigo-300 font-semibold mt-2 ${subheadingBlue}`}>S³ – Spectral Extraction</h4>
              <ul className="list-disc ml-8 my-2">
              ...
              <h4 className={`text-indigo-300 font-semibold mt-2 ${subheadingBlue}`}>R³ – Resonance Modeling</h4>
              <ul className="list-disc ml-8 my-2">
              ...
              <h4 className={`text-indigo-300 font-semibold mt-2 ${subheadingBlue}`}>C³ – Cognitive Circuitry</h4>
              <ul className="list-disc ml-8 my-2">
              ...
              <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>8.3 Epistemological Reversal</h3>
              <p>Traditionally, the structure of music is analyzed in this direction:</p>
              <div className="flex justify-center my-2">
                <BlockMath math={String.raw`\text{Notation} \rightarrow \text{Structure} \rightarrow \text{Sound}`} />
              </div>
              <p>
                <b>SRC⁹ reverses this process</b> to reflect perceptual and neuroscientific realism:
              </p>
              <div className="flex justify-center my-2">
                <BlockMath math={String.raw`\text{Sound} \rightarrow \text{Resonance} \rightarrow \text{Cognition}`} />
              </div>
              <p>
              ...
              <div className="p-8" style={{ background: cardBg, color: textColor }}>
                <h2 className={`text-2xl font-bold mb-4 ${headingRed}`}>What is C³? — Cognitive Consonance Circuit</h2>
              ...
              <div className="p-8" style={{ background: cardBg, color: textColor }}>
                <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.3 Output Structure</h3>
                <p>
              ...
              <div className="p-8" style={{ background: cardBg, color: textColor }}>
                <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.4 Scientific Rationale</h3>
                <p>
              ...
              <div className="p-8" style={{ background: cardBg, color: textColor }}>
                <h3 className={`text-xl font-semibold mt-6 mb-2 ${subheadingBlue}`}>2.5 Applications and Integration</h3>
                <p>
