...
const C3Gradient = () => (
  <span className="font-extrabold bg-gradient-to-r from-yellow-300 via-lime-400 to-green-500 bg-clip-text text-transparent">C³</span>
);
  ...
  return (
    <div className="animate-fadein min-h-screen flex flex-col items-center justify-start bg-black pt-8">
      ...
      <div className="relative w-full flex flex-col items-center">
        ...
        />
        {/* Fade-out overlay for video edges */}
        <div
          style={{
            pointerEvents: 'none',
            position: 'absolute',
            ...
            background: `
              linear-gradient(to top, rgba(0,0,0,0.85) 0px, rgba(0,0,0,0) 50px, rgba(0,0,0,0) calc(100% - 50px), rgba(0,0,0,0.85) 100%),
              linear-gradient(to left, rgba(0,0,0,0.85) 0px, rgba(0,0,0,0) 50px, rgba(0,0,0,0) calc(100% - 50px), rgba(0,0,0,0.85) 100%)
            `,
            zIndex: 2
          }}
        />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-start bg-black/40 rounded-xl">
          <div className="w-full max-w-4xl px-4 md:px-8 pt-[32%]">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white mb-6 text-center drop-shadow-lg">
              <C3Gradient /> – Cognitive Consonance Circuit is where sound becomes experience.
            </h2>
            <div className="backdrop-blur-sm bg-black/30 rounded-xl p-6">
              ...
              <div className="mt-12 text-2xl md:text-3xl font-extrabold text-white text-center tracking-wide">
                Welcome to the top layer of the SRC⁹ system.<br/>
                Welcome to the <span className="bg-gradient-to-r from-yellow-300 via-lime-400 to-green-500 bg-clip-text text-transparent font-extrabold">Cognitive Consonance Circuit</span>.
              </div>
            </div>
          </div>
        </div>
